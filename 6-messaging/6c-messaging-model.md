...
* [Messaging technology choices](https://docs.microsoft.com/en-us/azure/architecture/guide/technology-choices/messaging)

## Vasters On.NET Live notes

Services don't compete, they are a family for different messaging patters.

![Messaging core services](assets/6c-eventing-messaging-core-services.png)
...
![Service Bus patterns](assets/6c-service-bus-patterns.png)
...
![Competing consumers](assets/6c-service-bus-competing-consumers.png)
...
![Event hubs](assets/6c-event-hubs.png)

![Event hubs latency](assets/6c-event-hubs-proc-latency.png)

### Event Grid Architectural Patterns

* Push-push distribution
* Web hook down? What's your app gonna do, sit and wait?
    * Event grid will try reach the endpoint for 24 hours
    * back off if there's errors
    * dead letter if it can't deliver

![Event grid](assets/6c-event-grid.png)
...
![Event journeys](assets/6c-event-journeys.png)
...
![Event Grid](assets/6c-event-grid2.png)
